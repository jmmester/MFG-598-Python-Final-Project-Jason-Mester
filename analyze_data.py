# -*- coding: utf-8 -*-
"""
Created on Tue Apr 11 13:01:32 2023
...
#Tells which file to complete
s = 5

# read CSV
df = pd.read_csv(f'amazon_book_info_search_page_{s}.csv')
...
writer = pd.ExcelWriter(f'amazon_book_info_search_page_{s}ex.xlsx', engine='openpyxl')
df.to_excel(writer, index=False)

# assign the workbook and worksheet objects
...
# save the Excel file
workbook.save(f'amazon_book_info_search_page_{s}ex.xlsx')

# open the Excel file to view the sesults
os.startfile(f'amazon_book_info_search_page_{s}ex.xlsx')
